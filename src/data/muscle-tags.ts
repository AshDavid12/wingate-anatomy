...
export const MUSCLE_TAGS: Record<string, MuscleTag> = {
  ...
  "triceps-brachii": { actions: ["extension"], joints: ["elbow", "gh"] },
  anconeus: { actions: ["extension", "stabilize"], joints: ["elbow"] },
  "pronator-teres": { actions: ["pronation", "flexion"], joints: ["ru", "elbow"] },
  ...
  "psoas-major": { actions: ["flexion", "anterior-tilt"], joints: ["hip", "spine"] },
  ...
  tfl: { actions: ["flexion", "abduction", "internal-rotation"], joints: ["hip", "knee"] },
  ...
  gracilis: { actions: ["adduction", "flexion"], joints: ["hip", "knee"] },
  "rectus-femoris": { actions: ["extension", "flexion"], joints: ["knee", "hip"] },
  ...
  "biceps-femoris": { actions: ["flexion", "extension", "external-rotation"], joints: ["knee", "hip"] },
  semitendinosus: { actions: ["flexion", "extension", "internal-rotation"], joints: ["knee", "hip"] },
  semimembranosus: { actions: ["flexion", "extension", "internal-rotation"], joints: ["knee", "hip"] },
  gastrocnemius: { actions: ["plantarflexion", "flexion"], joints: ["ankle", "knee"] },
  soleus: { actions: ["plantarflexion"], joints: ["ankle"] },
  plantaris: { actions: ["plantarflexion", "flexion"], joints: ["ankle", "knee"] },
